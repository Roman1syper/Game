...
from text import ninja_evil_t
from main import *
from anim import NPS_CRYSTAL, NPS_NINJA_EVIL,NPS_NINJA_EVIL2,icon_ninja_evil
pygame.init()
...
def main5_2(hero,screen,death_list):
    global level
    level = []
        ...
        for col in row: # каждый символ
            if col == "-":
                ...
                if random_stone % death_list['random'][4] == 0:
                    ...
                    entities.add(pf)
                    platforms.append(pf)
            elif col == "N" and death_list['ninja_win'] == 1 and death_list['ninja_death'] != 1:
                ninja_evil = Dialogue_img(x - 21,y - 16,84,72,NPS_NINJA_EVIL,NPS_NINJA_EVIL2,0,icon_ninja_evil,'assets/other/not_in.png',0,22,28,3,'ninja_evil',ninja_evil_t,False,False,True,84,72)
                animatedEntities2.add(ninja_evil)
                entities2.add(ninja_evil)
                fait_character.append(ninja_evil)
