...
def main0(hero,screen,death_list):
    global level
    #print(8)
    level = []
        ...
        for col in row: # каждый символ
            if col == "-":
                ...
                if random_grass % death_list['random'][2][10] == 0:
                    ...
                    flip_x = False
                if number_grass != 0:
                    t = f'assets/grass/grass2_{number_grass}.png'
                ...
                if random_mushroom3 % death_list['random'][3][0] == 0:
                    if random_mushroom3 >= 10 and random_mushroom3 <= 20:
                        mushroom = 'assets/tree/mushroom_min0.png'
                        hp = -int(hero.health_max // 10)
                        hp_max = 2
                    elif random_mushroom3 <= 10:
                ...
                obelisk = Dialogue_img(x - 50,y - 70,190,240,NPS_OBELISK,NPS_OBELISK,0,'assets/other/not_in.png','assets/other/not_in.png',0,-1,28,3,'obelisk',obelisk_t[3])
