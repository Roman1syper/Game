...
def main8(hero,screen,death_list):
    global level
    #print(8)
    level = []
    ...
    for row in level: # вся строка
        for col in row: # каждый символ
            if col == "-":
                ...
                number2 += 1
                obelisk = Dialogue_img(x - 50,y - 70,190,240,NPS_OBELISK,NPS_OBELISK,0,'assets/other/not_in.png','assets/other/not_in.png',0,-1,28,3,'obelisk',obelisk_t[number2])
